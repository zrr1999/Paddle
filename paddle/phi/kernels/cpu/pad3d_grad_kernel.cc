...
void Pad3dGradKernel(const Context& dev_ctx,
  ...
  const int64_t num = static_cast<int64_t>(d_in_dims[0]);
  if (data_format == "NCDHW") {
    const int64_t channels = static_cast<int64_t>(d_in_dims[1]);
    const int64_t in_depth = static_cast<int64_t>(d_in_dims[2]);
    const int64_t in_height = static_cast<int64_t>(d_in_dims[3]);
    const int64_t in_width = static_cast<int64_t>(d_in_dims[4]);
    const int64_t out_depth = static_cast<int64_t>(d_out_dims[2]);
    const int64_t out_height = static_cast<int64_t>(d_out_dims[3]);
    const int64_t out_width = static_cast<int64_t>(d_out_dims[4]);
    ...
    const int64_t channels = static_cast<int64_t>(d_in_dims[4]);
    const int64_t in_depth = static_cast<int64_t>(d_in_dims[1]);
    const int64_t in_height = static_cast<int64_t>(d_in_dims[2]);
    const int64_t in_width = static_cast<int64_t>(d_in_dims[3]);
    const int64_t out_depth = static_cast<int64_t>(d_out_dims[1]);
    const int64_t out_height = static_cast<int64_t>(d_out_dims[2]);
    const int64_t out_width = static_cast<int64_t>(d_out_dims[3]);
